...
;   `(whitespace-trailing (,k--error-light))
	 ...
	 `(org-hide (,k--UNSET))
	 `(org-level-1 (,k--text-big3))
	 `(org-level-2 (,k--text-big2))
	 `(org-level-3 (,k--text-big1))
	 `(org-level-4 (,k--text-bold))
	 `(org-level-5 (,k--text-bold))
	 `(org-level-6 (,k--text-bold))
	 `(org-level-7 (,k--text-bold))
	 `(org-level-8 (,k--text-bold))
